((e, t) => {
    ...
    return {
      from: function (e) {
        return (
          ...
          u(t.prototype, "constructor", t),
          { extend: N.bind(null, t.prototype) }
        );
      },
    };
  }
  ...
  function c(e, t) {
    ...
    var a,
      u = t.indexOf(".");
    return -1 === u || null == (a = e[t.substr(0, u)])
      ? void 0
      : c(a, t.substr(u + 1));
  }
  function b(e, t, n) {
      ...
      if ("string" != typeof t && "length" in t) {
        ...
        -1 !== u
          ? ((i = t.substr(0, u)),
            "" === (u = t.substr(u + 1))
              ? void 0 === n
                ? x(e) && !isNaN(parseInt(i))
                  ? e.splice(i, 1)
                  : delete e[i]
                : (e[i] = n)
              : b((a = (a = e[i]) && m(e, i) ? a : (e[i] = {})), u, n))
          : void 0 === n
  ...
  function ee(e) {
    ...
    e = (function e(t) {
      ...
      if (x(t)) {
        ...
        var i,
          a = F(t);
        for (i in ((n = a === Object.prototype ? {} : Object.create(a)),
        Z.set(t, n),
        t))
          m(t, i) && (n[i] = e(t[i]));
      }
  ...
  var re = "undefined" != typeof Symbol ? Symbol.iterator : "@@iterator",
    oe =
      "symbol" == typeof re
        ? function (e) {
            var t;
  ...
  function he(e, t) {
    ((this.name = "BulkError"),
      ...
      (this.message = le(e, this.failures)));
  }
  (U(ce)
    .from(Error)
    .extend({
          ...
          e
            ? "string" == typeof e
              ...
              : "object" == typeof e &&
                ...
                (this.inner = e))
            : ((this.message = se[n] || r), (this.inner = null)));
      }
  ...
  e = t.reduce(function (e, t) {
    return (
      -1 === ["Syntax", "Type", "Range"].indexOf(t) && (e[t + "Error"] = k[t]),
      e
    );
  }, {});
  function g() {}
    ...
    return o === g
      ...
      : function () {
          var e = o.apply(this, arguments),
            t = (void 0 !== e && (arguments[0] = e), this.onsuccess),
            n = this.onerror,
            r =
              ((this.onsuccess = null),
              (this.onerror = null),
          ...
          return (
            t && (this.onsuccess = this.onsuccess ? be(t, this.onsuccess) : t),
            n && (this.onerror = this.onerror ? be(n, this.onerror) : n),
            void 0 !== r ? r : e
          );
        };
  }
    ...
    return n === g
      ...
      : function () {
          ...
          ((this.onsuccess = this.onerror = null),
            ...
            e && (this.onsuccess = this.onsuccess ? be(e, this.onsuccess) : e),
            t && (this.onerror = this.onerror ? be(t, this.onerror) : t));
        };
  }
  function _e(o, i) {
    return o === g
      ...
      : function (e) {
          ...
          return (
            e && (this.onsuccess = this.onsuccess ? be(e, this.onsuccess) : e),
            n && (this.onerror = this.onerror ? be(n, this.onerror) : n),
            void 0 === t ? (void 0 === r ? void 0 : r) : a(t, r)
          );
        };
  }
  function xe(e, t) {
  ...
  function K(e) {
    ...
    if ("function" != typeof e) {
      ...
      ((this._state = arguments[1]),
        ...
        !1 === this._state && Ue(this, this._value));
    } else
      ((this._state = null),
        (this._value = null),
        ++t.ref,
        ...
        t._state ||
          ...
          ((e) => {
            for (var t = qe.length; t; )
              if (qe[--t]._value === e._value) return qe.splice(t, 1);
          })(t),
        n.resolve(r));
    } catch (e) {
      n.reject(e);
  ...
  (N(K.prototype, {
    ...
    "undefined" != typeof Symbol &&
      Symbol.toStringTag &&
      u(K.prototype, Symbol.toStringTag, "Dexie.Promise"),
    (s.env = it()),
    N(K, {
      all: function () {
    ...
    je &&
          ...
          return new K(function (n) {
            ...
            e.forEach(function (e, t) {
              return K.resolve(e)
                .then(
                  function (e) {
                    return (o[t] = { status: "fulfilled", value: e });
                  },
                  function (e) {
                    return (o[t] = { status: "rejected", reason: e });
                  },
                )
                .then(function () {
                  return --r || n(o);
      ...
      je.withResolvers) &&
      (K.withResolvers = je.withResolvers));
  var i = { awaits: 0, echoes: 0, id: 0 },
    He = 0,
    Je = [],
    Ze = 0,
    et = 0,
  ...
  function v() {
    return (
      !!i.awaits &&
      (0 == --i.awaits && (i.id = 0), (i.echoes = i.awaits * Ke), !0)
    );
  }
  function rt(e) {
    return i.echoes && e && e.constructor === je
      ? (nt(),
        e.then(
          function (e) {
            return (v(), e);
  ...
  function h(e, t) {
    var n,
      r,
      o = P;
    ((t ? !i.echoes || (Ze++ && e === P) : !Ze || (--Ze && e === P)) ||
      queueMicrotask(
        t
          ? function (e) {
              (++et,
                (i.echoes && 0 != --i.echoes) ||
                  (i.echoes = i.awaits = i.id = 0),
                Je.push(P),
                h(e, !0));
            }.bind(null, e)
          : ot,
      ...
      e !== P &&
        ((P = e), o === s && (s.env = it()), Ae) &&
        ((n = s.env.Promise), (r = e.env), o.global || e.global) &&
        (Object.defineProperty(f, "Promise", r.PromiseProp),
        (n.all = r.all),
        (n.race = r.race),
        (n.resolve = r.resolve),
        (n.reject = r.reject),
  ...
  var w = K.reject;
  var ct = String.fromCharCode(65535),
    S =
  ...
  function gt(e) {
    var t = typeof e;
    return "object" == t &&
      (ArrayBuffer.isView(e) || "ArrayBuffer" === (t = ne(e)))
      ? "binary"
      : t;
  }
  function wt(e) {
      ...
      ? (n &&
        ...
        Promise.all(
          e.map(function (e) {
            e = e.updatesTable;
            return n
              ? t.db.table(e).where("k").anyOf(n).delete()
              : t.db.table(e).clear();
          }),
        ).then(function () {
          return r;
  ...
  function Ot(e, t) {
    for (var n = O(t), r = n.length, o = !1, i = 0; i < r; ++i) {
      var a = n[i],
        ...
        s = c(e, a);
      u instanceof xt
        ? (b(e, a, u.execute(s)), (o = !0))
        : s !== u && (b(e, a, u), (o = !0));
    }
    return o;
  }
  ((r.prototype._trans = function (e, r, t) {
    var n = this._tx || P.trans,
      o = this.name,
      i =
        l &&
        ...
        n && n.db._novip === this.db._novip
          ? n === P.trans
            ...
            : y(
                ...
                { trans: n, transless: P.transless || P },
              )
          : (function t(n, r, o, i) {
              if (
                n.idbdb &&
                (n._state.openComplete || P.letThrough || n._vip)
              ) {
                var a = n._createTransaction(r, o, n._dbSchema);
                try {
                  (a.create(), (n._state.PR1398_maxLoop = 3));
                } catch (e) {
                  return e.name === de.InvalidState &&
                    n.isOpen() &&
              ...
              if (n._state.openComplete)
                return w(new k.DatabaseClosed(n._state.dbOpenError));
    ...
    (r.prototype.where = function (i) {
      ...
      if (e && this.db._maxKey !== ct)
        return (
          (t = e.keyPath.slice(0, n.length)),
          this.where(t).equals(
            t.map(function (e) {
              return i[e];
            }),
      ...
      var t = n.reduce(
        ...
        t = t[1];
      return r
        ? this.where(r.name).equals(i[r.keyPath]).filter(t)
        : e
          ? this.filter(t)
          : this.where(n).equals("");
    }),
    ...
    (r.prototype.mapToClass = function (r) {
      for (
        var i = this.db,
          a = this.name,
          o =
            ((this.schema.mappedClass = r).prototype instanceof bt &&
              (r = ((e) => {
                var t = o,
                  n = e;
    ...
    (r.prototype.upsert = function (r, o) {
      ...
      return this._trans("readwrite", function (n) {
        return i.core.get({ trans: n, key: r }).then(function (t) {
          var e = null != t ? t : {};
          return (
            Ot(e, o),
            a && b(e, a, r),
    ...
    (r.prototype.update = function (e, t) {
      return "object" != typeof e || x(e)
        ? this.where(":id").equals(e).modify(t)
        : void 0 === (e = c(e, this.schema.primKey.keyPath))
          ? w(
    ...
    (r.prototype.delete = function (t) {
      ...
      return this._trans("readwrite", function (e) {
        return n.core
          .mutate({ trans: e, type: "delete", keys: [t] })
          .then(function (e) {
            return _t(n, [t], e);
          })
          .then(function (e) {
    ...
    (r.prototype.clear = function () {
      ...
      return this._trans("readwrite", function (e) {
        return t.core
          .mutate({ trans: e, type: "deleteRange", range: vt })
          .then(function (e) {
            return _t(t, null, e);
          });
      }).then(function (e) {
    ...
    (r.prototype.bulkAdd = function (o, e, t) {
      ...
      return this._trans("readwrite", function (e) {
        ...
        var r = o.length,
          n = t && n ? o.map(mt(t)) : o;
        return i.core
          .mutate({ trans: e, type: "add", keys: a, values: n, wantResults: u })
          .then(function (e) {
            var t = e.numFailures,
              n = e.failures;
    ...
    (r.prototype.bulkPut = function (o, e, t) {
      ...
      return this._trans("readwrite", function (e) {
        ...
        var r = o.length,
          n = t && n ? o.map(mt(t)) : o;
        return i.core
          .mutate({ trans: e, type: "put", keys: a, values: n, wantResults: u })
          .then(function (e) {
            var t = e.numFailures,
              n = e.failures;
            if (0 === t) return u ? e.results : e.lastResult;
        ...
        return (
          ...
          (i = {
            ...
            subscribe: function (e) {
              -1 === i.subscribers.indexOf(e) &&
                (i.subscribers.push(e), (i.fire = n(i.fire, e)));
            },
  ...
  function It(e, i, t, n) {
    var a,
      r,
      u = e.replayFilter ? yt(e.filter, e.replayFilter()) : e.filter;
    return e.or
      ? ((a = {}),
        (r = function (e, t, n) {
          var r, o;
          (u &&
            ...
            ("[object ArrayBuffer]" === (o = "" + (r = t.primaryKey)) &&
              (o = "" + new Uint8Array(r)),
            m(a, o)) ||
            ((a[o] = !0), i(e, t, n));
        }),
        Promise.all([
          e.or._iterate(r, t),
          qt(Tt(e, n, t), e.algorithm, r, !e.keysOnly && e.valueMapper),
        ]))
      : qt(Tt(e, n, t), yt(e.algorithm, u), i, !e.keysOnly && e.valueMapper);
  }
  function qt(e, r, o, i) {
    var a = E(
      i
  ...
  ((o.prototype._read = function (e, t) {
      ...
      return this._read(function (e) {
        ...
        return St(n, !0)
          ? r
              .count({
                trans: e,
                query: { index: Ct(n, r.schema), range: n.range },
              })
              .then(function (e) {
    ...
    (o.prototype.toArray = function (e) {
      ...
      return this._read(function (e) {
        var t,
          ...
          r,
          o = i._ctx;
        return "next" === o.dir && St(o, !0) && 0 < o.limit
          ? ((t = o.valueMapper),
            (n = Ct(o, o.table.core.schema)),
            o.table.core
              .query({
                trans: e,
                limit: o.limit,
                values: !0,
                query: { index: n, range: o.range },
              })
              .then(function (e) {
                e = e.result;
                return t ? e.map(t) : e;
    ...
    (o.prototype.filter = function (t) {
      var e;
      return (
        jt(this._ctx, function (e) {
          return t(e.value);
        }),
        ((e = this._ctx).isMatch = yt(e.isMatch, t)),
        this
      );
    }),
    ...
    (o.prototype.primaryKeys = function (e) {
      var n = this._ctx;
      if ("next" === n.dir && St(n, !0) && 0 < n.limit)
        return this._read(function (e) {
    ...
    (o.prototype.modify = function (x) {
      ...
      return this._write(function (p) {
        ...
        var v =
          ...
          m = k.table.core,
          e = m.schema.primaryKey,
          b = e.outbound,
          g = e.extractKey,
          w = 200,
          e = n.db._options.modifyChunkSize,
          a =
            (e && (w = "object" == typeof e ? e[m.name] || e["*"] || 200 : e),
            []),
          u = 0,
          t = [],
          _ = x === Bt;
        return n
          ...
          .then(function (f) {
            function h(s) {
              var c = Math.min(w, f.length - s),
                l = f.slice(s, s + c);
              return (
                _
                  ? Promise.resolve([])
                  : m.getMany({ trans: p, keys: l, cache: "immutable" })
              ).then(function (e) {
                var n = [],
                  t = [],
                  r = b ? [] : null,
                ...
                if (!_)
                  for (var i = 0; i < c; ++i) {
                    var a = e[i],
                      u = { value: ee(a), primKey: f[s + i] };
                    !1 !== v.call(u, u.value, u) &&
                      (null == u.value
                        ? o.push(f[s + i])
                        : b || 0 === j(g(a), g(u.value))
                          ? (t.push(u.value), b && r.push(f[s + i]))
                          : (o.push(f[s + i]), n.push(u.value)));
                  }
                return Promise.resolve(
                  0 < n.length &&
                    m
                      .mutate({ trans: p, type: "add", values: n })
                      .then(function (e) {
            ...
            return h(0).then(function () {
              if (0 < a.length)
                throw new fe("Error modifying one or more objects", a, u, t);
              return f.length;
            });
          });
      });
    ...
    (o.prototype.delete = function () {
      var o = this._ctx,
        n = o.range;
      return !St(o) || o.table.schema.yProps || (!o.isPrimKey && 3 !== n.type)
        ? this.modify(Bt)
        : this._write(function (e) {
            var t = o.table.core.schema.primaryKey,
              r = n;
            return o.table.core
    ...
    (d.prototype.anyOf = function () {
      ...
      return 0 === i.length
        ...
        : (((e = new this.Collection(this, function () {
          ...
          (o = 0),
          e._addAlgorithm(function (e, t, n) {
            for (var r = e.key; 0 < a(r, i[o]); )
              if (++o === i.length) return (t(n), !1);
            return (
              0 === a(r, i[o]) ||
              (t(function () {
                e.continue(i[o]);
  ...
  var zt = "storagemutated",
    ...
    Yt = Kt(null, zt),
    $t =
      ((p.prototype._lock = function () {
        return (
          $(!P.global),
          ++this._reculock,
          1 !== this._reculock || P.global || (P.lockOwnerFor = this),
          this
        );
      }),
      (p.prototype._unlock = function () {
        if (($(!P.global), 0 == --this._reculock))
          for (
        ...
        if (this.mode) {
          ...
          ($(null === this._completion._state),
            ...
            (t.oncomplete = E(function () {
              ((n.active = !1),
                n._resolve(),
                "mutatedParts" in t && Yt.storagemutated.fire(t.mutatedParts));
            })));
        }
        return this;
      }),
      (p.prototype._promise = function (n, r, o) {
        var e,
          i = this;
        return "readwrite" === n && "readwrite" !== this.mode
          ? w(new k.ReadOnly("Transaction is readonly"))
          : this.active
            ? this._locked()
              ? new K(function (e, t) {
      ...
      return {
        ...
        mutate: function (e) {
          ...
          return new Promise(function (t, e) {
            ...
            if ("deleteRange" === v) {
              ...
              3 === g.type
                ? s.push((i = n.clear()))
                : s.push((i = n.delete(_(g))));
            } else {
              var r = o ? (r ? [b, m] : [b, null]) : [m, null],
                f = r[0],
                h = r[1];
              if (o)
                for (var d = 0; d < a; ++d)
                  (s.push(
                    (i = h && void 0 !== h[d] ? n[v](f[d], h[d]) : n[v](f[d])),
                  ),
                    (i.onerror = u));
              else
                for (d = 0; d < a; ++d)
                  (s.push((i = n[v](f[d]))), (i.onerror = u));
            }
            function p(e) {
              ((e = e.target.result),
          ...
          function (f) {
            return new Promise(function (n, e) {
              ...
              var r,
                ...
                s = s.range,
                t = t.objectStore(w),
                t = l.isPrimaryKey ? t : t.index(l.name),
                l = _(s);
              if (0 === u) return n({ result: [] });
              h
                ? (((s = a ? t.getAll(l, c) : t.getAllKeys(l, c)).onsuccess =
                    function (e) {
                ...
                : ((r = 0),
                  (o =
                    !a && "openKeyCursor" in t
                      ? t.openKeyCursor(l)
                      : t.openCursor(l)),
                  (i = []),
                  (o.onsuccess = function (e) {
                    var t = o.result;
                    return !t || (i.push(a ? t.value : t.primaryKey), ++r === u)
                      ? n({ result: i })
                      : void t.continue();
                  }),
                  (o.onerror = T(e)));
        ...
        openCursor: function (e) {
          ...
          return new Promise(function (t, n) {
            ...
            var e = a.index,
              ...
              s =
                !i && "openKeyCursor" in o
                  ? o.openKeyCursor(_(r), e)
                  : o.openCursor(_(r), e);
            ((s.onerror = T(n)),
              (s.onsuccess = E(function (e) {
                var r,
                  o,
                  i,
                  a,
        ...
        count: function (e) {
          var t = e.query,
            ...
            a = t.range;
          return new Promise(function (t, e) {
            var n = o.objectStore(w),
              n = i.isPrimaryKey ? n : n.index(i.name),
              r = _(a),
              r = r ? n.count(r) : n.count();
  ...
  function rn(e, t, n, r) {
    ...
    return (
      (t = nn(t, n, r)),
      {
        dbcore: e.dbcore.reduce(function (e, t) {
          t = t.create;
          return _(_({}, e), t(e));
        }, t),
      }
  ...
  function on(n, e) {
    var t = e.db,
      t = rn(n._middlewares, t, n._deps, e);
    ((n.core = t.dbcore),
      n.tables.forEach(function (e) {
        ...
        n.core.schema.tables.some(function (e) {
          ...
          ((e.core = n.core.table(t)), n[t] instanceof n.Table) &&
          (n[t].core = e.core);
      }));
  }
  function an(o, e, t, i) {
    ...
    var i = n._dbSchema,
      a =
        (o.objectStoreNames.contains("$meta") &&
          !i.$meta &&
          ((i.$meta = Xt("$meta", mn("")[0], [])), n._storeNames.push("$meta")),
        n._createTransaction("readwrite", n._storeNames, i)),
      u = (a.create(o), a._completion.catch(e), a._reject.bind(a)),
      s = P.transless || P;
    y(function () {
      if (((P.trans = a), (P.transless = s), 0 !== r))
        return (
          on(n, o),
          (t = r),
            ...
            .then(function (e) {
              ...
              return 0 ===
                ...
                : (e.forEach(function (u) {
                    (t.push(function () {
                      ...
                      if (a && u._cfg.version > c)
                        return (
                          ...
                          an(s, [s.Transaction.prototype], O(t), t),
                          (l.schema = t),
                          (n = ue(a)) && nt(),
                          (e = K.follow(function () {
                            var e;
                  ...
                  (function e() {
                    return t.length
                      ? K.resolve(t.shift()(l.idbtrans)).then(e)
                      : K.resolve();
                  })().then(function () {
                    dn(h, f);
                  }));
  ...
  function dn(t, n) {
    O(t).forEach(function (e) {
      n.db.objectStoreNames.contains(e) ||
        (l && console.debug("Dexie: Creating missing table", e),
        hn(n, e, t[e].primKey, t[e].indexes));
    });
  }
  function pn(e, t) {
  ...
  function yn(e, t, u) {
    var s = {};
    return (
      W(t.objectStoreNames, 0).forEach(function (e) {
        for (
    ...
    for (var r = n.db.objectStoreNames, o = 0; o < r.length; ++o) {
      ...
      for (var u = 0; u < a.indexNames.length; ++u) {
        var s,
          c = a.indexNames[u],
          l = a.index(c).keyPath,
          l = "string" == typeof l ? l : "[" + W(l).join("+") + "]";
        t[i] &&
          (s = t[i].idxByName[l]) &&
          ((s.name = c), delete t[i].idxByName[l], (t[i].idxByName[c] = s));
      }
    }
    "undefined" != typeof navigator &&
      /Safari/.test(navigator.userAgent) &&
  ...
  function mn(e) {
    return e.split(",").map(function (e, t) {
      var n = e.split(":"),
        r = null == (r = n[1]) ? void 0 : r.trim(),
        n = (e = n[0].trim()).replace(/([&*]|\+\+)/g, ""),
        o = /^\[/.test(n) ? n.match(/^\[(.*)\]$/)[1].split("+") : n;
      return Qt(
        n,
        o || null,
        /\&/.test(e),
  ...
  ((gn.prototype._createTableSchema = Xt),
    (gn.prototype._parseIndexSyntax = mn),
    (gn.prototype._parseStoresSpec = function (r, o) {
      var i = this;
      O(r).forEach(function (e) {
        if (null !== r[e]) {
          var t = i._parseIndexSyntax(r[e]),
            n = t.shift();
          if (!n)
            throw new k.Schema("Invalid schema for table " + e + ": " + r[e]);
    ...
    (gn.prototype.upgrade = function (e) {
      return (
        (this._cfg.contentUpgrade = ke(this._cfg.contentUpgrade || g, e)),
        this
      );
    }));
  var bn = gn;
  ...
  function wn(e, t) {
    ...
    return (
      n ||
        (n = e._dbNamesDB =
          new q(ht, { addons: [], indexedDB: e, IDBKeyRange: t }))
          .version(1)
          .stores({ dbnames: "name" }),
      n.table("dbnames")
    );
  ...
  function On(e, t, n) {
    ...
    if (!isNaN(r)) {
      ...
      if (j(n, e.from) < 0)
        return (
          r ? On(r, t, n) : (e.l = { from: t, to: n, d: 1, l: null, r: null }),
          Sn(e)
        );
      if (0 < j(t, e.to))
        return (
          o ? On(o, t, n) : (e.r = { from: t, to: n, d: 1, l: null, r: null }),
          Sn(e)
        );
      (j(t, e.from) < 0 &&
  ...
  function Kn(e, t) {
    ...
    if (!r.done)
      for (
        var o = r.value, i = En(e), a = i.next(o.from), u = a.value;
        !r.done && !a.done;
      ) {
      ...
      next: function (e) {
        for (var t = 0 < arguments.length; n; )
          switch (n.s) {
            case 0:
              if (((n.s = 1), t))
                for (; n.n.l && j(e, n.n.from) < 0; )
                  n = { up: n, n: n.n.l, s: 1 };
              else for (; n.n.l; ) n = { up: n, n: n.n.l, s: 1 };
            case 1:
              if (((n.s = 2), !t || j(e, n.n.to) <= 0))
  ...
  function Sn(e) {
    var t,
      ...
      r,
      o =
        ((null == (o = e.r) ? void 0 : o.d) || 0) -
        ((null == (o = e.l) ? void 0 : o.d) || 0),
      o = 1 < o ? "r" : o < -1 ? "l" : "";
    (o &&
      ((t = "r" == o ? "l" : "r"),
      (n = _({}, e)),
          ...
          : (t[e] = (function e(t) {
              ...
              for (n in t)
                m(t, n) &&
                  ((r = t[n]),
                  (o[n] =
                    !r || "object" != typeof r || J.has(r.constructor)
                      ? r
                      : e(r)));
              return o;
            })(n[e]));
  ...
  function Bn(e, t) {
    ...
    var n = new Set();
    if (e.all)
      for (var r = 0, o = Object.values(Tn); r < o.length; r++)
        Rn((u = o[r]), e, n, t);
    else
      for (var i in e) {
        var a,
  ...
  function Fn(h) {
    ...
    var t = d.openCanceller,
      p = Math.round(10 * h.verno),
      y = !1;
    function e() {
      if (d.openCanceller !== t)
    ...
    function v() {
      return new K(function (c, n) {
        ...
        var l = h.name,
          f = d.autoSchema || !p ? r.open(l) : r.open(l, p);
        if (!f) throw new k.MissingAPI();
        ((f.onerror = T(n)),
          (f.onblocked = E(h._fireOnBlocked)),
          (f.onupgradeneeded = E(function (e) {
            var t;
            ((m = f.transaction),
              d.autoSchema && !h._options.allowEmptyDB
                ? ((f.onerror = Vt),
                  m.abort(),
                  f.result.close(),
                  ((t = r.deleteDatabase(l)).onsuccess = t.onerror =
                    E(function () {
                      n(
                ...
                : ((m.onerror = T(n)),
                  (t = e.oldVersion > Math.pow(2, 62) ? 0 : e.oldVersion),
                  (b = t < 1),
                  (h.idbdb = f.result),
                  y && ln(h, m),
                  cn(h, t / 10, m, n)));
          }, n)),
          (f.onsuccess = E(function () {
            m = null;
            var e,
              t,
              n,
            ...
            if (0 < u.length)
              try {
                ...
                if (d.autoSchema)
                  ((i = a),
                    (r = s),
                    ((n = h).verno = i.version / 10),
                    (r = n._dbSchema = yn(0, i, r)),
                    (n._storeNames = W(i.objectStoreNames, 0)),
                    an(n, [n._allTables], O(r), r));
                else if (
                  (vn(h, h._dbSchema, s),
                  (t = s),
                  ((t = fn(yn(0, (e = h).idbdb, t), e._dbSchema)).add.length ||
                    t.change.some(function (e) {
            ...
            (ft.push(h),
              (a.onversionchange = E(function (e) {
              ...
              b &&
                ...
                _n((i = u.indexedDB)) ||
                  o === ht ||
                  wn(i, u.IDBKeyRange).put({ name: o }).catch(g)),
              c());
          }, n)));
      }).catch(function (e) {
    ...
    return K.race([
        ...
        return (
          ...
          K.resolve(
            ...
            if (0 < d.onReadyBeingFired.length)
              return (
                (t = d.onReadyBeingFired.reduce(ke, g)),
                (d.onReadyBeingFired = []),
                K.resolve(
                  xn(function () {
                    return t(h.vip);
      ...
      .finally(function () {
        d.openCanceller === t &&
          ((d.onReadyBeingFired = null), (d.isBeingOpened = !1));
      })
      .catch(function (e) {
        d.dbOpenError = e;
        try {
          ...
          b &&
            ...
            h.tables.forEach(function (t) {
              (t.schema.indexes.forEach(function (e) {
                ...
                (n["idb://".concat(h.name, "/").concat(t.name, "/")] = n[
                  "idb://".concat(h.name, "/").concat(t.name, "/:dels")
                ] =
                  new I(-1 / 0, [[[]]])));
            }),
            Yt(zt).fire(n),
      ...
      return _(_({}, l), {
        table: function (e) {
          ...
          function c(e, t, n) {
            var r = tn(e),
              o = (u[r] = u[r] || []),
              i = null == e ? 0 : "string" == typeof e ? 1 : e.length,
              a = 0 < t,
              r = _(_({}, n), {
                name: a
            ...
            return (
              ...
              1 < i && c(2 === i ? e[0] : e.slice(0, i - 1), t + 1, n),
              o.sort(function (e, t) {
                  ...
                  query: {
                    ...
                    range:
                      ...
                      (n = n.keyTail),
                      {
                        ...
                        lower: Nn(
                          t.lower,
                          t.lowerOpen ? l.MAX_KEY : l.MIN_KEY,
                          n,
                        ),
                        lowerOpen: !0,
                        upper: Nn(
                          t.upper,
                          t.upperOpen ? l.MIN_KEY : l.MAX_KEY,
                          n,
                        ),
                        upperOpen: !0,
                      }),
          ...
          return _(_({}, i), {
            ...
            openCursor: function (t) {
              var e = t.query.index,
                ...
                o = e.keyLength;
              return e.isVirtual
                ? i.openCursor(a(t)).then(function (e) {
                    return e && n(e);
                  })
                : i.openCursor(t);
              function n(n) {
                return Object.create(n, {
                  continue: {
                    value: function (e) {
                      null != e
                        ? n.continue(
                            Nn(e, t.reverse ? l.MAX_KEY : l.MIN_KEY, r),
                          )
                        : t.unique
                          ? n.continue(
                              n.key
                                .slice(0, o)
                                .concat(t.reverse ? l.MIN_KEY : l.MAX_KEY, r),
                            )
                          : n.continue();
                    },
                  },
                    ...
                    "delete" !==
                      (c =
                        "add" === c.type || "put" === c.type
                          ? _(_({}, c), { keys: f })
                          : _({}, c)).type && (c.values = R([], c.values, !0)),
                    c.keys && (c.keys = R([], c.keys, !0)),
                    (e = y),
                    (n = f),
                    ("add" === (t = c).type
                      ? Promise.resolve([])
                            ...
                            : "add" === c.type || void 0 === i
                              ? ((n = d.fire.call(a, e, c.values[t], l)),
                                null == e &&
                                  null != n &&
                                  ((c.keys[t] = e = n),
                                  v.outbound || b(c.values[t], v.keyPath, e)))
                              : ((n = Un(i, c.values[t])),
                                (r = p.fire.call(a, n, e, i, l)) &&
                                  ((o = c.values[t]),
  ...
  function Wn(e, t, n) {
    try {
      ...
      for (var r = [], o = 0, i = 0; o < t.keys.length && i < e.length; ++o)
        0 === j(t.keys[o], e[i]) &&
          (r.push(n ? ee(t.values[o]) : t.values[o]), ++i);
        ...
        table: function (e) {
          ...
          return _(_({}, n), {
            getMany: function (t) {
              var e;
              return t.cache
                ? (e = Wn(t.keys, t.trans._cache, "clone" === t.cache))
                  ? K.resolve(e)
  ...
  var Gn = {
    ...
    create: function (b) {
      var g = b.schema.name,
        w = new I(b.MIN_KEY, b.MAX_KEY);
      return _(_({}, b), {
        transaction: function (e, t, n) {
          if (P.subscr && "readonly" !== t)
        ...
        table: function (d) {
          function e(e) {
            ...
            return [
              (t = e.index),
              new I(
                null != (t = (e = e.range).lower) ? t : b.MIN_KEY,
                null != (t = e.upper) ? t : b.MAX_KEY,
              ),
            ];
          }
          var p = b.table(d),
                ...
                return (
                  ...
                  p.mutate(a).then(function (i) {
                    return (
                      ...
                      (t.mutatedParts = An(t.mutatedParts || {}, n)),
                      i
                    );
                  })
                );
          ...
          return (
            O(f).forEach(function (s) {
              n[s] = function (o) {
                var e = P.subscr,
                  t = !!e,
                  n = $n(P, p) && Qn(s, o) ? (o.obsSet = {}) : e;
                if (t) {
                  var i,
                    e = function (e) {
                      e = "idb://".concat(g, "/").concat(d, "/").concat(e);
                    ...
                    t = t[1];
                  if (
                    (("query" === s && r.isPrimaryKey && !o.values
                      ? u
                      : e(r.name || "")
                    ).add(t),
                    !r.isPrimaryKey)
                    ...
                    if ("count" !== s)
                      return (
                        (i =
                          ...
                          l &&
                          o.values &&
                          p.query(_(_({}, o), { values: !1 }))),
                        p[s].apply(this, arguments).then(function (t) {
                          if ("query" === s) {
                            if (l && o.values)
  ...
  function Xn(e, t, n) {
    ...
    return 0 === n.numFailures
      ...
      : "deleteRange" === t.type ||
        ...
        : ((r = _({}, t)),
          x(r.keys) &&
            (r.keys = r.keys.filter(function (e, t) {
              return !(t in n.failures);
            })),
          "values" in r &&
            x(r.values) &&
            (r.values = r.values.filter(function (e, t) {
              return !(t in n.failures);
            })),
          r);
  }
  function Hn(e, t) {
    return (
      (n = e),
      (void 0 === (r = t).lower ||
        (r.lowerOpen ? 0 < j(n, r.lower) : 0 <= j(n, r.lower))) &&
        ((n = e),
        void 0 === (r = t).upper ||
          (r.upperOpen ? j(n, r.upper) < 0 : j(n, r.upper) <= 0))
    );
    var n, r;
  }
  function Jn(e, d, t, n, r, o) {
    ...
    return !t ||
      ...
      (m = i.extractKey),
      (a = (i.lowLevelIndex || i).extractKey),
      (n = t.reduce(function (e, t) {
        var n = e,
          r = [];
        if ("add" === t.type || "put" === t.type)
          for (var o = new I(), i = t.values.length - 1; 0 <= i; --i) {
            var a,
              u = t.values[i],
              s = v(u);
            !o.hasKey(s) &&
      ...
      : (n.sort(function (e, t) {
        ...
        d.limit &&
          ...
          (n.length > d.limit
            ? (n.length = d.limit)
            : e.length === d.limit && n.length < d.limit && (r.dirty = !0)),
        o ? Object.freeze(n) : n);
  }
  function Zn(e, t) {
    return (
    ...
    create: function (k) {
      ...
      return _(_({}, k), {
        transaction: function (g, w, e) {
          ...
          return (
            "readwrite" === w &&
              ((e = (_ = new AbortController()).signal),
              x.addEventListener(
                "abort",
                (t = function (b) {
                  return function () {
                    if ((_.abort(), "readwrite" === w)) {
                      for (var t = new Set(), e = 0, n = g; e < n.length; e++) {
                        var r = n[e],
                          o = Tn["idb://".concat(O, "/").concat(r)];
                        if (o) {
                          var i = k.table(r),
                            a = o.optimisticOps.filter(function (e) {
                              return e.trans === x;
                            });
                          if (x._explicit && b && x.mutatedParts)
                            for (
                              var u = 0, s = Object.values(o.queries.query);
                              u < s.length;
                              u++
                            )
                              for (
                                ...
                                Cn((p = l[c]).obsSet, x.mutatedParts) &&
                                  (ie(d, p),
                                  p.subscribers.forEach(function (e) {
                                    return t.add(e);
                                  }));
                          else if (0 < a.length) {
                            o.optimisticOps = o.optimisticOps.filter(
                              function (e) {
                                return e.trans !== x;
                              },
                            );
                            for (
                              var f = 0, h = Object.values(o.queries.query);
                              f < h.length;
                              f++
                            )
                              for (
              ...
              x.addEventListener("error", t(!1), { signal: e }),
              x.addEventListener("complete", t(!0), { signal: e })),
            x
          );
        },
        table: function (s) {
          var c = k.table(s),
            o = c.schema.primaryKey;
          return _(_({}, c), {
            mutate: function (t) {
              var n,
                e = P.trans;
              return !o.outbound &&
                ...
                (n = Tn["idb://".concat(O, "/").concat(s)])
                ? ((e = c.mutate(t)),
                  ("add" !== t.type && "put" !== t.type) ||
                  !(
                    50 <= t.values.length ||
                    Vn(o, t).some(function (e) {
                      return null == e;
                    })
                  )
                    ? (n.optimisticOps.push(t),
                      t.mutatedParts && Dn(t.mutatedParts),
                      e.then(function (e) {
                        0 < e.numFailures &&
                          (ie(n.optimisticOps, t),
                          (e = Xn(0, t, e)) && n.optimisticOps.push(e),
                          t.mutatedParts) &&
                          Dn(t.mutatedParts);
                      }),
                      e.catch(function () {
            ...
            query: function (t) {
              var o, e, n, r, i, a, u;
              return $n(P, c) && Qn("query", t)
                ? ((o =
                    "immutable" ===
                    (null == (n = P.trans) ? void 0 : n.db._options.cache)),
                  (e = (n = P).requery),
                  (n = n.signal),
                  (a = ((e, t, n, r) => {
                    var o = Tn["idb://".concat(e, "/").concat(t)];
                    if (!o) return [];
                    if (!(e = o.queries[n])) return [null, !1, o, null];
                    ...
                    : ((a = c
                      ...
                      i
                        ...
                        : ((i = [u]),
                          ((r =
                            r ||
                            (Tn["idb://".concat(O, "/").concat(s)] = {
                              queries: { query: {}, count: {} },
                              objs: new Map(),
                              optimisticOps: [],
                              unsignaledParts: {},
                            })).queries.query[t.query.index.name || ""] = i))),
                  tr(u, i, e, n),
  ...
  ((D.prototype.version = function (t) {
    ...
    (D.prototype._whenReady = function (e) {
      var n = this;
      return this.idbdb &&
        (this._state.openComplete || P.letThrough || this._vip)
        ? e()
        : new K(function (e, t) {
            if (n._state.openComplete)
              return t(new k.DatabaseClosed(n._state.dbOpenError));
            if (!n._state.isBeingOpened) {
    ...
    (D.prototype.use = function (e) {
      ...
      return (
        o.push({ stack: t, create: n, level: null == r ? 10 : r, name: e }),
        o.sort(function (e, t) {
    ...
    (D.prototype._close = function () {
      ...
      n.isBeingOpened ||
        ((n.dbReadyPromise = new K(function (e) {
          n.dbReadyResolve = e;
        })),
    ...
    (D.prototype.close = function (e) {
      var e = (void 0 === e ? { disableAutoOpen: !0 } : e).disableAutoOpen,
        t = this._state;
      e
        ? (t.isBeingOpened && t.cancelOpen(new k.DatabaseClosed()),
          this._close(),
          (t.autoOpen = !1),
          (t.dbOpenError = new k.DatabaseClosed()))
        : (this._close(),
    ...
    (D.prototype.delete = function (n) {
      var o = this,
        i =
          ...
          0 < arguments.length && "object" != typeof arguments[0]),
        a = this._state;
        ...
        function e() {
          ...
          ((e.onsuccess = E(function () {
            ...
            ((e = o._deps),
              ...
              _n((n = e.indexedDB)) ||
                t === ht ||
                wn(n, e.IDBKeyRange).delete(t).catch(g),
              r());
          })),
            (e.onerror = T(t)),
            (e.onblocked = o._fireOnBlocked));
        }
        if (i)
          throw new k.InvalidArgument(
    ...
    (D.prototype._transaction = function (e, t, n) {
      ...
      try {
        if (
          ...
          if ("rw" != e && e != pt)
            throw new k.InvalidArgument("Invalid transaction mode: " + e);
          r = pt;
        }
        if (a) {
          if (a.mode === dt && r === pt) {
      ...
      var s = function o(i, a, u, s, c) {
        return K.resolve().then(function () {
          var e = P.transless || P,
            t = i._createTransaction(a, u, i._dbSchema, s),
            e = ((t.explicit = !0), { trans: t, transless: e });
          if (s) t.idbtrans = s.idbtrans;
          else
            try {
              (t.create(),
                (t.idbtrans._explicit = !0),
                (i._state.PR1398_maxLoop = 3));
            } catch (e) {
              return e.name === de.InvalidState &&
                i.isOpen() &&
                0 < --i._state.PR1398_maxLoop
                ? (console.warn("Dexie: Need to reopen db"),
  ...
  function D(e, t) {
    var i,
      ...
      o,
      u = this,
      s = ((this._middlewares = {}), (this.verno = 0), D.dependencies),
      s =
        ((this._options = t =
          _(
            {
      ...
      l =
        ((c.dbReadyPromise = new K(function (e) {
          c.dbReadyResolve = e;
        })),
        ...
        (this._state = c),
        (this.name = e),
        (this.on = Kt(this, "populate", "blocked", "versionchange", "close", {
          ready: [ke, g],
        })),
          ...
          return function (n, r) {
            D.vip(function () {
              var t,
                e = u._state;
              e.openComplete
                ? (e.dbOpenError || K.resolve().then(n), r && o(n))
                : e.onReadyBeingFired
                  ? (e.onReadyBeingFired.push(n), r && o(n))
                  : (o(n),
                    (t = u),
                    r ||
                      o(function e() {
        ...
        (this.Collection =
          ...
          Et(Dt.prototype, function (e, t) {
            ...
            var t = e._ctx,
              e = t.table,
              o = e.hook.reading.fire;
            this._ctx = {
              table: e,
              index: t.index,
              isPrimKey:
                !t.index ||
                (e.schema.primKey.keyPath && t.index === e.schema.primKey.name),
              range: n,
              keysOnly: !1,
              dir: "next",
              unique: "",
        ...
        (this.Table =
          ((r = this),
          Et(Pt.prototype, function (e, t, n) {
            ((this.db = r),
              (this._tx = n),
              (this.name = e),
              (this.schema = t),
        ...
        (this.Transaction =
          ((a = this),
          Et($t.prototype, function (e, t, n, r, o) {
            var i = this;
            ("readonly" !== e &&
              t.forEach(function (e) {
              ...
              (this._spinCount = 0),
              (this._completion = new K(function (e, t) {
        ...
        (this.WhereClause =
          ((o = this),
          Et(Ut.prototype, function (e, t, n) {
            if (
              ((this.db = o),
              (this._ctx = { table: e, index: ":id" === t ? null : t, or: n }),
              (this._cmp = this._ascending = j),
          ...
          get: function (e, t, n) {
            ...
            return (
              ...
              ("table" === t
                ...
                : (r = Reflect.get(e, t, n)) instanceof Pt
                  ? rr(r, l)
                  : "tables" === t
                    ? r.map(function (e) {
                        return rr(e, l);
  ...
  var or,
    Se =
      "undefined" != typeof Symbol && "observable" in Symbol
        ...
        : "@@observable",
    ir =
      ((ar.prototype.subscribe = function (e, t, n) {
          ...
          e = {
            ...
            unsubscribe: function () {
              a ||
                ((a = !0),
                i && i.abort(),
                c && Yt.storagemutated.unsubscribe(f));
            },
          },
          c = (r.start && r.start(e), !1),
          l = function () {
            return st(t);
          };
        var f = function (e) {
  ...
  (N(
        ...
        try {
          return (
            ...
            (_n(n)
              ...
              : wn(n, t).toCollection().primaryKeys()
            ).then(e)
          );
        } catch (e) {
    ...
    (sr.maxKey = Ht(sr.dependencies.IDBKeyRange)),
    "undefined" != typeof dispatchEvent &&
      "undefined" != typeof addEventListener &&
      (Yt(zt, function (e) {
        fr ||
          ((e = new CustomEvent(Wt, { detail: e })),
          (fr = !0),
          dispatchEvent(e),
          (fr = !1));
      }),
    ...
    "undefined" != typeof addEventListener &&
      (addEventListener("pagehide", function (e) {
        if (!q.disableBfCache && e.persisted) {
          (l && console.debug("Dexie: handling persisted pagehide"),
            null != lr && lr.close());
          for (var t = 0, n = ft; t < n.length; t++)
      ...
      addEventListener("pageshow", function (e) {
        !q.disableBfCache &&
          e.persisted &&
          (l && console.debug("Dexie: handling persisted pageshow"),
          hr(),
          cr({ all: new I(-1 / 0, [[]]) }));
      })),
